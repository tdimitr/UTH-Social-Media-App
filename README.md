...
- **Delete Post** 🗑️:  
  Remove posts that you no longer wish to share with your community.
...
- Ensure you configure the necessary environment variables by filling out the `.env` file.
